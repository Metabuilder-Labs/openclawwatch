...
def _tool_get_budget_headroom(conn, config, agent_id: str) -> dict:
    if config is None:
        return _no_config()
    from tj.core.config import resolve_effective_budget
...
def _tool_list_alerts(
    ...
    from tj.core.models import AlertFilters, Severity
...
def _tool_setup_project(
    ...
    from tj.core.config import write_config, AgentConfig
