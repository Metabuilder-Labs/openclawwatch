...
class OcwAttributes:
    ...
    SESSION_ID       = "session.id"
    ALERT_TYPE       = "tj.alert.type"
    ALERT_SEVERITY   = "tj.alert.severity"
    # NemoClaw / OpenShell sandbox events
    SANDBOX_EVENT    = "tj.sandbox.event"
    EGRESS_HOST      = "tj.sandbox.egress_host"
    EGRESS_PORT      = "tj.sandbox.egress_port"
    FILESYSTEM_PATH  = "tj.sandbox.filesystem_path"
    SYSCALL_NAME     = "tj.sandbox.syscall_name"
